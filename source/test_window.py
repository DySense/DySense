...
class TestWindow(QWidget):
    ...
    def create_new_sensor_view(self, *args):
        pass
    
    def add_sensor_to_list_widget(self, *args):
        pass
    
    def update_sensor_list_widget(self, *args):
        pass
    ...
    def start_button_clicked(self):
        ...
        if self.test_step == 1:
            ...
            if len(self.presenter.sensors) == 0:
        ...
        if self.test_step == 4:
            ...
            self.start_button.setText('Setup All sensors')
        ...
        if self.test_step == 5:
            ...
            self.display_message("Telling presenter to setup all sensors...")
            self.presenter.setup_all_sensors(False)
    ...
    def update_all_sensor_info(self, controller_id, sensor_id, sensor_info):
        ...
        self.presenter.sensors[(controller_id, sensor_id)] = sensor_info
    ...
    def update_sensor_info(self, controller_id, sensor_id, info_name, value):
        self.display_message("Sensor {} had \'{}\' changed to {}".format(self.presenter.sensors[(controller_id, sensor_id)]['sensor_name'],
                                                                        info_name, value))
    ...
    def show_new_sensor_data(self, controller_id, sensor_id, data):
        ...
        if not self.presenter.sensors[(controller_id, sensor_id)]['posted_about_receiving_data']:
            self.display_message("Sensor {} new data {}".format(sensor_id, data))
            self.presenter.sensors[(controller_id, sensor_id)]['posted_about_receiving_data'] = True
