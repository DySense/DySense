...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.platform_type_label = QtGui.QLabel(self.settings_group_box)
        self.platform_type_label.setObjectName(_fromUtf8("platform_type_label"))
        self.gridLayout_4.addWidget(self.platform_type_label, 3, 0, 1, 1)
        ...
        self.platform_type_line_edit = QtGui.QLineEdit(self.settings_group_box)
        self.platform_type_line_edit.setObjectName(_fromUtf8("platform_type_line_edit"))
        self.gridLayout_4.addWidget(self.platform_type_line_edit, 3, 1, 1, 1)
        ...
        self.ack_all_issues_button = QtGui.QPushButton(self.menu_page)
        self.ack_all_issues_button.setObjectName(_fromUtf8("ack_all_issues_button"))
        self.horizontalLayout_8.addWidget(self.ack_all_issues_button)
        spacerItem4 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_8.addItem(spacerItem4)
        self.gridLayout_3.addLayout(self.horizontalLayout_8, 13, 1, 1, 1)
        self.current_issues_table = QtGui.QTableWidget(self.menu_page)
        self.current_issues_table.setObjectName(_fromUtf8("current_issues_table"))
        self.current_issues_table.setColumnCount(0)
        self.current_issues_table.setRowCount(0)
        self.gridLayout_3.addWidget(self.current_issues_table, 12, 1, 1, 1)
        self.issues_label = QtGui.QLabel(self.menu_page)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.issues_label.setFont(font)
        self.issues_label.setAlignment(QtCore.Qt.AlignCenter)
        self.issues_label.setObjectName(_fromUtf8("issues_label"))
        self.gridLayout_3.addWidget(self.issues_label, 11, 1, 1, 1)
        ...
        MainWindow.setTabOrder(self.operator_name_line_edit, self.platform_type_line_edit)
        MainWindow.setTabOrder(self.platform_type_line_edit, self.platform_id_line_edit)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ack_all_issues_button.setText(_translate("MainWindow", "Acknowledge All Issues", None))
        self.issues_label.setText(_translate("MainWindow", "Current Issues", None))
