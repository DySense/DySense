...
class ComponentConnection(object):
    ...
    def __init__(self, interface, heartbeat_period, connected_component_id):
        '''
        Constructor.
        
        :param interface: ServerInterface or ClientInterface that owns this connection object.
        :param float heartbeat_period: Expected interval (in seconds) that the connected component
                                       should be sending heartbeat messages at.
        ...
        self._connected_component_heartbeat_period = heartbeat_period
        
        # If we don't receive a new message in this time then consider component dead. (in seconds) 
        self._component_timeout_thresh = self._heartbeat_period * 10
        ...
        self._interface_connection_time = 0
    ...
    def refresh_state(self):
        ...
        This will be called automacially be interface after processing new messages.
        '''
    ...
    def stopped_responding(self):
        ...
        if self._interface_connection_time == 0 or self._last_message_processing_time == 0:
        ...
        if self._num_messages_received == 0:
            ...
            time_since_connecting = self._last_message_processing_time - self._interface_connection_time
