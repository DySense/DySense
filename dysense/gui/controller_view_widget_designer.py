...
class Ui_controller_view(object):
    def setupUi(self, controller_view):
        ...
        self.view_output_button = QtGui.QToolButton(self.command_buttons_frame)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.view_output_button.sizePolicy().hasHeightForWidth())
        self.view_output_button.setSizePolicy(sizePolicy)
        self.view_output_button.setMinimumSize(QtCore.QSize(60, 60))
        self.view_output_button.setAutoFillBackground(True)
        self.view_output_button.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.view_output_button.setAutoRaise(True)
        self.view_output_button.setObjectName(_fromUtf8("view_output_button"))
        self.gridLayout.addWidget(self.view_output_button, 3, 1, 1, 1)
    ...
    def retranslateUi(self, controller_view):
        ...
        self.view_output_button.setText(_translate("controller_view", "View Output", None))
