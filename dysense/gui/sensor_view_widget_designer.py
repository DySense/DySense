...
class Ui_sensor_view(object):
    def setupUi(self, sensor_view):
        ...
        sensor_view.setTabOrder(self.forward_position_line_edit, self.left_position_line_edit)
        sensor_view.setTabOrder(self.left_position_line_edit, self.up_position_line_edit)
        sensor_view.setTabOrder(self.up_position_line_edit, self.roll_orientation_line_edit)
    ...
    def retranslateUi(self, sensor_view):
        ...
        self.left_position_label.setText(_translate("sensor_view", "Left:", None))
        self.up_position_label.setText(_translate("sensor_view", "Up:", None))
